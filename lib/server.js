        ...
        momentDirectory.forEach( (momentDir) => {
            ...
            fs.readFile('./vault/' + momentDir + '/data/' + momentDir + '.json', 'utf8', (err, data) => {
                ...
                if(data.templates){
                    ...
                    // data.templates.forEach( (plate) => {
                    //     // console.log('plate', plate.media.length)
                    //     imageCount += plate.media.length
                    // } )

                    // totalImageCount += imageCount;
                    // console.log('All Images', totalImageCount);
                    // console.log('All Templates', totalTemplates);
